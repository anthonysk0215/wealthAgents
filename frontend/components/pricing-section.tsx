  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for exploring AI-powered wealth planning.",
      features: [
        "Full 12-agent financial analysis",
        "Live agent trace visualization",
        "Basic allocation recommendations",
        "Single wealth plan generation",
        "Community support",
      ],
    ...
    },
    {
      ...
      features: [
        ...
        "12-month & 5-year roadmaps",
        "Full agent transcript access",
        "Priority email support",
        "Monthly market recalibration",
      ],
      buttonText: "Join now",
      buttonClass:
    ...
    },
    {
      ...
      monthlyPrice: "$199",
      annualPrice: "$149",
      description: "Multi-household wealth management.",
      features: [
        "Up to 10 household profiles",
        "Dedicated wealth manager agent",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Pricing for every wealth journey
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            From first-time investors to multi-generational wealth, <br /> choose the plan that matches your financial goals.
          </p>
        </div>
        <div className="pt-4">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Starter" ? "text-gray-800" : plan.name === "Investor" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
